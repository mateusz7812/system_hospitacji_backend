...
class Protocol:
    def __init__(self, id: str, zapoznano_sie_z_karta_przedmiotu: bool, status: ProtocolStatus, data_utworzenia: datetime, data_wystawienia: datetime, data_podpisu: datetime, data_odwolania: datetime, komisja_hospitujaca_id: str):
        self.id = id
        ...
        self.appelation_date = data_odwolania
